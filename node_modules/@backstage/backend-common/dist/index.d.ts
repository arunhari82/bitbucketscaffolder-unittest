...
import { LoggerService, CacheServiceOptions, CacheService, TokenManagerService, ServiceRef, AuthService, HttpAuthService, UserInfoService, IdentityService, DiscoveryService, resolvePackagePath as resolvePackagePath$1, resolveSafeChildPath as resolveSafeChildPath$1, isChildPath as isChildPath$1, DatabaseService, LifecycleService, PluginMetadataService, UrlReaderService, ReadTreeResponse, ReadUrlOptions, ReadUrlResponse, ReadTreeOptions, SearchOptions, SearchResponse } from '@backstage/backend-plugin-api';
...
declare class ServerTokenManager implements TokenManagerService {
    ...
    static fromConfig(config: Config, options: ServerTokenManagerOptions): TokenManagerService;
    private constructor();
